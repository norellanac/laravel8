                ...
                <div class="col-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1"
                            placeholder="Escriba el nombre" value="{{ $role->name }}" required>
                    </div>
                </div>
                <div class="col-5">
                    <div class="form-group">
                        <label>Descripcion</label>
                        <textarea class="form-control" rows="1" name="descripcion" placeholder="Descripcion..."
                            required></textarea>
                    </div>
                </div>
                <div class="col-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2 col-sm-2 col-md-2">
                                        <div class="form-group">
                                            <div class="form-group form-check mt-2">
                                                <input type="checkbox" class="form-check-input"
                                                    onchange="selectColumchecks('usersDelete')">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="usersList"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'role-list')->first()->id }}"
                                                {{ in_array($permission->where('name', 'role-list')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="userscreate"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'role-create')->first()->id }}"
                                                {{ in_array($permission->where('name', 'role-create')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="usersEdit"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'role-edit')->first()->id }}"
                                                {{ in_array($permission->where('name', 'role-edit')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="usersDelete"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'role-delete')->first()->id }}"
                                                {{ in_array($permission->where('name', 'role-delete')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="usersList"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'user-list')->first()->id }}"
                                                {{ in_array($permission->where('name', 'user-list')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="userscreate"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'user-create')->first()->id }}"
                                                {{ in_array($permission->where('name', 'user-create')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="usersEdit"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'user-edit')->first()->id }}"
                                                {{ in_array($permission->where('name', 'role-edit')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-2 col-sm-2 col-md-2">
                                    <div class="form-group">
                                        <div class="form-group form-check mt-3">
                                            <input type="checkbox" class="form-check-input" id="usersDelete"
                                                name="permission[]"
                                                value="{{ $permission->where('name', 'user-delete')->first()->id }}"
                                                {{ in_array($permission->where('name', 'user-delete')->first()->id, $rolePermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
